...
export default function Footer() {
  return (
    <footer className="bg-background mt-20 px-5 md:px-12 text-foreground py-5 w-screen">
      <div className="flex flex-col justify-center items-center md:flex-row md:justify-between text-center md:text-right gap-5">
        ...
        <div>
          ...
          <div className="mt-5 text-white/60 md:text-right">
      ...
      <div className="text-sm flex flex-col md:flex-row justify-between md:items-center gap-5 mt-14 text-center md:text-right">
        <div className="opacity-50 order-2 md:order-1">All rights reserved. 2024 ©</div>
        <div className="flex items-center justify-center gap-1 md:order-2">
